...
1. **Pick a prompt (1 min).** Draw from file 13 (the 6 worked system designs — forecasting, fraud, recsys, attribution, RAG chatbot, ad-budget bandits), file 20 (case studies B1-B7, D1-D3, and the ambiguous "what would you do" prompts in section F double well as system-design springboards), or file 16 (the "millions of alerts" multi-agent security platform design, if that track is relevant to your target role). Pick one you haven't just read, or better, have someone else pick for you so you can't pattern-match from memory of the page layout.
...
- **10-15 = solid but has gaps.** Note which 2-3 rubric items scored 0-1, re-drill the same prompt in 2-3 days after reviewing that specific gap in file 13's framework section.
- **< 10 = needs more reps.** Re-read file 13's general framework section, then redo this exact prompt within 24 hours before moving to a new one.

Log your score in the Part 3 tracker under file 13, file 20, or file 16, whichever the prompt came from.

### 2. Technical Q&A rapid-fire drill

Files 01-13 each end with an **"Additional Common Interview Questions"** section, and several (04, 05, 06) also have a **"Popular Questions — Full Answers"** section plus inline **"Interview angle"** callouts scattered through the body. This drill turns that scattered Q&A into a retrieval-practice deck.
...
File 19's Part 4 (coding exercises) and Part 5 (whiteboard/algorithm exercises) are meant to be *attempted*, not read.
...
File 20's case-study bank (sections A-F, ~29 prompts across business/product, applied ML, GenAI, forecasting/ops, experimentation, and ambiguous "what would you do" scenarios) is built for this drill specifically.

**Protocol:**

1. Pick **3 random prompts** from file 20 (literally roll a die against the numbered list, or have a partner pick, so you can't cherry-pick ones you already feel strong on).
...
- **Onsite loop**: some combination of an ML case study or system design round (file 13 / file 20 drills above), a live coding round, a stats/ML fundamentals round (files 01-07, rapid-fire drill above), and at least one behavioral/culture round. Order and exact mix varies a lot by company size — smaller companies often compress this into 2-3 rounds, larger companies spread it across 4-5.
...
### File 08 — SQL, PySpark, dbt & Data Engineering
- [ ] First full read-through complete
...
### File 09 — MLOps & Cloud Deployment
- [ ] First full read-through complete
...
### File 10 — NLP & Deep Learning Fundamentals
- [ ] First full read-through complete
- [ ] Can explain TF-IDF vs Word2Vec/GloVe/FastText tradeoffs and LSTM/GRU gating, unaided
- [ ] Can explain the pre-Transformer attention mechanism as a bridge concept to file 11
- [ ] Drilled all "Additional Common Interview Questions" at pass level
- [ ] Quick Recall Sheet reviewed within the last 3 days

### File 11 — GenAI, LLMs & Transformers
- [ ] First full read-through complete
...
- [ ] Can walk through causal masking, temperature/top-k/top-p decoding, KV cache, and continuous batching from memory
- [ ] Drilled all "Additional Common Interview Questions" at pass level
- [ ] Quick Recall Sheet reviewed within the last 3 days

### File 12 — RAG, Agents & LLM Systems
- [ ] First full read-through complete
- [ ] Can explain chunking strategy tradeoffs, hybrid search/reranking, and RAG failure modes without notes
- [ ] Can explain query rewriting/HyDE, parent-child retrieval, and access-control-aware retrieval, unaided
- [ ] Can explain LangGraph state graphs and multi-agent orchestration patterns, unaided
- [ ] Drilled all "Additional Common Interview Questions" at pass level
- [ ] Quick Recall Sheet reviewed within the last 3 days

### File 13 — ML System Design
- [ ] First full read-through complete
...
### File 14 — Agentic Systems Architecture & Evaluation
- [ ] First full read-through complete
- [ ] Can explain ReAct vs. plan-and-execute, and at least 3 multi-agent coordination patterns (including peer-to-peer), unaided
- [ ] Can answer "why might more agents make a system worse?" fully from memory
- [ ] Can name all five agent-evaluation layers and 2-3 metrics in each without notes, including regression testing / golden sets
- [ ] Can walk through the full "good yesterday, bad today" debugging checklist unaided
- [ ] Can explain failure isolation / bulkheading for multi-agent systems
- [ ] Quick Recall Sheet reviewed within the last 3 days

### File 15 — Security Fundamentals & AI/Agent Security
- [ ] First full read-through complete
- [ ] Can explain CIA triad, RBAC vs. ABAC, and zero trust without notes
- [ ] Can explain SIEM vs. SOAR vs. XDR vs. EDR and where MITRE ATT&CK fits, unaided
- [ ] Can explain direct vs. indirect prompt injection and the confused-deputy problem for an LLM agent, unaided
- [ ] Can state and defend "the model should never be the final authority on authorization" from memory
- [ ] Quick Recall Sheet reviewed within the last 3 days

### File 16 — Project Perception & Enterprise Platform Design
- [ ] First full read-through complete
- [ ] Can whiteboard the full Signals → Context → Models → Harness → Agents → Actuators pipeline in under 10 minutes, unaided
- [ ] Can explain why Red/Blue/Green is a closed loop, not independent chatbots
- [ ] Ran the System Design Rehearsal Drill (Part 1.1) on the "millions of alerts" platform design, scoring 16+/20
- [ ] Can name at least 3 reliability patterns and 3 latency levers without notes
- [ ] Can reason about CAP theorem / consistency-model tradeoffs across this platform's data stores
- [ ] Verified the current terminology/model names against Microsoft's own public material (not just this kit)
- [ ] Quick Recall Sheet reviewed within the last 3 days

### File 18 — Active Recall Flashcards
...
### File 19 — Practice Problems / Code
...
### File 20 — Case Studies & Applied Use-Case Bank
- [ ] First full read-through complete
...
### File 22 — Project Deep Dives
- [ ] First full read-through complete
- [ ] Personalized all three project templates with your real numbers, architecture decisions, and outcomes
- [ ] Can deliver each project's 20-second, 2-minute, and 10-minute-deep-dive versions without notes
- [ ] Can answer all 5 general project-defense questions using your real experience, not the template's
- [ ] Quick Recall Sheet reviewed within the last 3 days

### File 23 — Behavioral STAR Stories
- [ ] First full read-through complete
- [ ] Personalized all 9 story templates with your real situations, actions, and quantified results
- [ ] Can deliver 2 stories per common behavioral category without notes, in STAR form
- [ ] Rehearsed your 90-second "tell me about yourself" and both award stories (Rookie, Brightest Mind) out loud
- [ ] Quick Recall Sheet reviewed within the last 3 days
...
| 05 | Other ML Algorithms | SVM, k-NN, Naive Bayes, clustering, PCA/t-SNE/UMAP, anomaly detection | ☐ Not started / ☐ In progress / ☐ Drilled |
| 06 | Model Evaluation & Feature Engineering | Metrics, calibration, CV, imbalance, SHAP, ranking | ☐ Not started / ☐ In progress / ☐ Drilled |
| 07 | Time Series Forecasting | ARIMA/SARIMAX, Prophet, ML/DL forecasting | ☐ Not started / ☐ In progress / ☐ Drilled |
| 08 | SQL, PySpark, dbt & Data Engineering | Joins, window fns, Spark, dbt, pipelines | ☐ Not started / ☐ In progress / ☐ Drilled |
| 09 | MLOps & Cloud Deployment | MLflow, serving, Docker, CI/CD, drift, AWS/GCP | ☐ Not started / ☐ In progress / ☐ Drilled |
| 10 | NLP & Deep Learning Fundamentals | Embeddings, RNN/LSTM/GRU, attention | ☐ Not started / ☐ In progress / ☐ Drilled |
| 11 | GenAI, LLMs & Transformers | Self-attention, PEFT, RLHF/DPO, scaling laws, decoding, inference/serving | ☐ Not started / ☐ In progress / ☐ Drilled |
| 12 | RAG, Agents & LLM Systems | RAG, query rewriting, access control, LangChain/LangGraph, agent eval | ☐ Not started / ☐ In progress / ☐ Drilled |
| 13 | ML System Design | Framework + 6 worked designs | ☐ Not started / ☐ In progress / ☐ Drilled |
| 14 | Agentic Systems Architecture & Evaluation | Planning, memory, multi-agent coordination, agent eval, observability, reliability | ☐ Not started / ☐ In progress / ☐ Drilled |
| 15 | Security Fundamentals & AI/Agent Security | CIA/SOC/MITRE ATT&CK/identity + prompt injection/agent attacks/authorization | ☐ Not started / ☐ In progress / ☐ Drilled |
| 16 | Project Perception & Enterprise Platform Design | Signals-to-actuators architecture, system design, consistency, reliability, latency, cost | ☐ Not started / ☐ In progress / ☐ Drilled |
| 18 | Active Recall Flashcards | Full-kit flashcard deck | ☐ Not started / ☐ In progress / ☐ Drilled |
| 19 | Practice Problems / Code | Coding + whiteboard exercises | ☐ Not started / ☐ In progress / ☐ Drilled |
| 20 | Case Studies & Applied Use-Case Bank | ~29 business/ML/GenAI/ops/experimentation prompts | ☐ Not started / ☐ In progress / ☐ Drilled |
| 22 | Project Deep Dives | Forecasting, attribution, RL project defense | ☐ Not started / ☐ In progress / ☐ Drilled |
| 23 | Behavioral STAR Stories | STAR method + 9 story templates | ☐ Not started / ☐ In progress / ☐ Drilled |

---

## Part 4 — T-Minus Countdown

This is a multi-day **taper schedule** — it's about *when* to do what over the final week, distinct from file 17's Part 3, which is a same-morning walk-in-the-door checklist. Use this section to pace yourself across the days leading up to the interview; use file 17 only on the day itself.
...
### T-minus 3 days
- Drill the full file 18 flashcard deck end to end; isolate a "weak deck" of anything missed.
...
### Morning of
- Skim file 17 (the quickfire cram sheet) only — this is not the day to re-read full derivations.
- Skim your flagged flashcard misses one more time.
- Review your project narratives and behavioral stories (files 22 and 23) so they're fresh and specific, not generic.
