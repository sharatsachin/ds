...
The critical values are the values of the test statistic ($\bar{x}$) that cut off a tail of area $\alpha/2$ in each direction.
...
## How can you compare two populations $(\mu_1$, $\sigma_1)$ and $(\mu_2$, $\sigma_2)$ for small samples?
